...
try {
    ...
    $sql = "INSERT INTO user_concerns (bioID, fullName, concernType, subject, message, dateSubmitted, status)
            VALUES (:bioID, :fullName, 'Concern', :subject, :message, :dateSubmitted, 'Pending')";
